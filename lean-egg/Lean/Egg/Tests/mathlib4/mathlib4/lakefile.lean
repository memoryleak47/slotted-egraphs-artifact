...
require "leanprover-community" / "batteries" @ git "v4.14.0-rc1"
require "leanprover-community" / "Qq" @ git "v4.14.0-rc1"
require "leanprover-community" / "aesop" @ git "v4.14.0-rc1"
require "leanprover-community" / "proofwidgets" @ git "v0.0.46"
require "leanprover-community" / "importGraph" @ git "v4.14.0-rc1"
require "leanprover-community" / "LeanSearchClient" @ git "v4.12.0"
  from git "https://github.com/leanprover-community/LeanSearchClient" @ "v4.12.0"
require "leanprover-community" / "plausible" @ git "v4.14.0-rc1"
